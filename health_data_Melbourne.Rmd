...
**STEVE, could you please do a last check here and instead of using
cancer_socio data generate the data from Chris' incidence data)?**
...
-   For most cancers (all cancers, bladder, endometrial, head and neck,
    ...
    in the AIHW data (cancer_socioecononmic). BZD: **Noted, I went over
    the code to find discrepancies, but cannot see any. If we get new
    data we can test again.**
...
-   For breast and prostate cancers, the AHIW data shows rates
    ...
    not match this pattern. **BZD: I see, interesting, because the ATLAS
    graphs by single year of age show the patterns of higher rates for
    higher socio.**
...
####Clean and save data (BZD, eventually, move to the end of the code).
