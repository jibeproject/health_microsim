...
-   Dementia: `AIHW/dementia-mortality.xlsx`, Table S3.6. This is
    mortality data from AIHW, by socioeconomic quintile and sex,
    for 2021.
...
output plots are saved in the \`docs/images/prev_cvd_dem_dia_copd' folder.
...
highest to lowest, and there is little separation in rates of male dementia.
