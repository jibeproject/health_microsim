...
data_melbourne <- mort_disagg %>% 
  bind_rows(cancer_incidence_area, cancer_prevalence_area, 
            ...
            depression_incidence %>% mutate(rate = val_interpolated), 
            depression_prevalence %>% mutate(rate = val_interpolated)) %>%
...
mort_inc_melbourne <- data_melbourne %>%
  ...
  mutate(location_code = case_when(
    !is.na(sa2_code) & !is.na(educ) & !is.na(socio) ~ 
      paste(as.character(sa2_code), educ, as.character(socio), sep = "_"),
    !is.na(sa2_code) & !is.na(educ)  ~ paste(as.character(sa2_code), educ, sep = "_"),
    !is.na(sa2_code) & !is.na(socio) ~ paste(as.character(sa2_code), as.character(socio), sep = "_"),
  ...
  location_type = case_when(
    !is.na(sa2_code) & !is.na(educ) & !is.na(socio) ~ "SA2_educ_socio",
    !is.na(sa2_code) & !is.na(educ)  ~ "SA2_educ",
    !is.na(sa2_code) & !is.na(socio) ~ "SA2_socio",
...
prev_melbourne <- data_melbourne %>%
  filter(measure == "prevalence") %>%  mutate(location_code = case_when(
    !is.na(sa2_code) & !is.na(educ) & !is.na(socio) ~ 
      paste(as.character(sa2_code), educ, as.character(socio), sep = "_"),
    !is.na(sa2_code) & !is.na(educ)  ~ paste(as.character(sa2_code), educ, sep = "_"),
    !is.na(sa2_code) & !is.na(socio) ~ paste(as.character(sa2_code), as.character(socio), sep = "_"),
