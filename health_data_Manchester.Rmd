...
JIBE Manchester. The model initially has three stages where individuals
...
The mortality rate `mx` is defined as "the number of deaths at age x last birthday in the three year period (2017-2019) divided by the average population at that age over the same period.
...
A relative mortality rate is produced for each area,
