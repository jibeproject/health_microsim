...
health_transitions_manchester_prevalence <- health_transitions_manchester %>% filter(measure == "prevalence")

health_transitions_incidence <- health_transitions_manchester %>% filter(measure %in% c("incidence", "deaths"))

write.csv(health_transitions_manchester_prevalence, here("manchester/health/processed/health_transitions_manchester_prevalence.csv"))

write.csv(health_transitions_incidence, here("manchester/health/processed/health_transitions_manchester_raw.csv"))
```
