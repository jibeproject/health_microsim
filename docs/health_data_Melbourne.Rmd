...
health_outcomes_risks <- tibble::tribble(
  ...
  "Coronary heart disease", "GBD (I20-I21.6, I21.9-I25.9, Z82.4-Z82.49)", "AIHW (I20-I25)",  "PA (I20-I25)",
  "Breast cancer", "PA (C50)",
  "Endometrial cancer", "PA (C54)",
  "Lung cancer", "PA (C34)",
  "Colon cancer", "PA (C18)",
  "Esophageal cancer", "PA (C15)",
  "Liver cancer", "PA (C22-C24)",
  "Kidney cancer", "PA (C64-65)",
  "Gastric cardia cancer", "PA (C16.0)",
  "Myeloid leukemia", "PA (C92)",
  "Myeloma", "PA (90)",
  "Head and neck cancer", "PA (C76.0)",
  "Rectum cancer", "PA (C20)",
  "Bladder cancer", "PA (C67)",
  "Prostate cancer", "PA (C61)",
  "Malignant melanoma", "PA (C43)",
  "Depressive disorders", "GBD (F32-F33.9, F34.1)", "PA (F32-F33)",
  "All cause dementia", "PA (F01-F03)",
  "Diabetes type 2", "PA",
...
include data for depressive disorders.
