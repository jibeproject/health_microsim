...
### Incidence by age and sex, with adjustments for specific diseases
...
- Colon cancer, Rectum cancer: Colon and rectum cancer, apportioned based on AIHW incidence rates
...
## NEXT, combine the head and neck cancers, split colorectal, etc

```


### Adjust for specific cancers
