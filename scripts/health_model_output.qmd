...
synth_pop <- arrow::open_dataset(sources = here("manchester/health/processed/preliminary_results/base_pp_exposure_RR_2021.parquet")) |> collect()
...
m <- arrow::open_dataset(source = (here("manchester/health/processed/preliminary_results/exp_dis_inter_trans-n.c-10-n.i-2827285-n.d-19.parquet")))
